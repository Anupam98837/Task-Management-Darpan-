...
return new class extends Migration
{
    ...
    {
        Schema::create('fcm_tokens_admin', function (Blueprint $table) {
            $table->bigIncrements('id');

            // Link to admins (keep column name as user_id)
            ...
            // One FCM token should exist only once in the table
            $table->unique('fcm_admin', 'uniq_fcm_admin_token');
            ...
            $table->index('personal_access_token', 'idx_admin_pat');
    ...
    {
        Schema::dropIfExists('fcm_tokens_admin');
    }
};

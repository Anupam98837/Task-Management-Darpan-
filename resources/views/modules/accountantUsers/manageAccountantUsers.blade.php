        ...
        <div class="modal-body">
          ...
          <div class="row g-3">
            ...
            <div class="col-md-6 form-group">
              ...
              <input type="text" class="form-control" id="client_user_role" name="role" placeholder="Example: Senior Accountant">
            </div>
            <div class="col-md-6 form-group">
          ...
          <div class="form-group">
            ...
            <small class="muted-small mt-2 d-block">Selecting a parent client gives this accountant access to that full child tree.</small>
          </div>
...
(function(){
  ...
  els.rows.addEventListener('change', async (e) => {
    ...
    try {
      const res = await fetch(`${API_BASE}/accountant-users/${encodeURIComponent(id)}/toggle`, { method:'PATCH', headers });
      const data = await res.json().catch(() => ({}));
  ...
  els.form.addEventListener('submit', async (e) => {
    ...
    try {
      const url = isEdit ? `${API_BASE}/accountant-users/${encodeURIComponent(id)}` : `${API_BASE}/accountant-users`;
  ...
  els.exportBtn.addEventListener('click', () => {
    if (!state.items.length) {
      Swal.fire({ icon:'info', title:'Nothing to export', text:'No accountant users are loaded in the current view.' });
      return;
    }
    const rows = [

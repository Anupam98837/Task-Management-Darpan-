...
<head>
  ...
  <title>Admin Portal — Legmed Darpan</title>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* Left panel */
    .auth-panel {
      background:linear-gradient(155deg,#0c2847 0%,#0a3d62 40%,#0369a1 100%);
    ...
    .auth-panel::before { width:420px;height:420px; background:radial-gradient(circle,rgba(14,165,233,.25) 0%,transparent 70%); top:-100px;right:-100px; }
    .auth-panel::after  { width:320px;height:320px; background:radial-gradient(circle,rgba(56,189,248,.18) 0%,transparent 70%); bottom:-80px;left:-60px; }
    ...
    .panel-headline span { color:#38bdf8; }
    ...
    .feature-icon { width:40px;height:40px;border-radius:10px;background:rgba(255,255,255,.1);border:1px solid rgba(255,255,255,.14);display:flex;align-items:center;justify-content:center;color:#38bdf8;font-size:15px;flex-shrink:0; }
...
<div class="auth-wrap">
  ...
  <div class="auth-panel">
    ...
    <div class="panel-content">
      ...
      <h1 class="panel-headline">Manage smarter,<br><span>deliver faster</span></h1>
      <p class="panel-sub">Streamline workflows, track every task, and keep your entire team aligned — all from one powerful dashboard.</p>
      <div class="feature-list">
        <div class="feature-item"><div class="feature-icon"><i class="fas fa-user-shield"></i></div><span class="feature-text">Role-based access & team management</span></div>
        <div class="feature-item"><div class="feature-icon"><i class="fas fa-chart-line"></i></div><span class="feature-text">Real-time analytics & performance insights</span></div>
        <div class="feature-item"><div class="feature-icon"><i class="fas fa-tasks"></i></div><span class="feature-text">Advanced job assignment & prioritization</span></div>
        <div class="feature-item"><div class="feature-icon"><i class="fas fa-file-invoice-dollar"></i></div><span class="feature-text">Client billing & expense tracking</span></div>
      </div>
    </div>
  ...
  <div class="auth-form-side">
    <div class="auth-card">
      <div class="portal-badge"><i class="fas fa-user-shield"></i> Admin Portal</div>
      ...
      <p class="help-note">Contact your system administrator for access issues or account recovery.</p>
    </div>
  </div>
</div>
...
<script>
  ...
  async function login(){
    ...
    try{
      ...
      const res=await fetch('/api/admin/login',{method:'POST',headers:{'Content-Type':'application/json','Accept':'application/json','X-CSRF-TOKEN':csrf},body:JSON.stringify({identifier,password:passwordVal,remember})});
